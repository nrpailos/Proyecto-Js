...
let mostrarGastos = () => {
    ...
    if (arrayGastos === null) {
        ...
        arrayGastos.forEach(element => {
            listaGastosUI.innerHTML += `<div class="alert alert-dark" role="alert">
            <i class="material-icons float-left mr-3"></i>
            <b>${element.gasto}</b> - ${element.descripcion} - ${element.date} 
            <span class="float-right"><i class="material-icons">delete</i></span></div>`
        });
    }
}
